  ...
  <script src="{{ asset('estudiante/assets/js/core/popper.min.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('estudiante/assets/js/plugins/perfect-scrollbar.jquery.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('estudiante/assets/js/plugins/bootstrap-notify.js') }}"></script>
